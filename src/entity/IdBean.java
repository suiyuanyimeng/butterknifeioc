...
public class IdBean extends JPanel {
    ...
    private JTextField annotationForId;
     ...
     * id注释接口
     */
    public interface AnnotationForId {
        void setAnnotationForId(JTextField fieldJTextField);
    }

    private FieldFocusListener mFieldFocusListener;
    private AnnotationForId annotationForIdFocusListener;

    public void setFieldFocusListener(FieldFocusListener fieldFocusListener) {
        mFieldFocusListener = fieldFocusListener;
    }

    public void setAnnotationForIdFocusListener(AnnotationForId annotationForIdFocusListener) {
        this.annotationForIdFocusListener = annotationForIdFocusListener;
    }
    ...
    public IdBean(LayoutManager layout, EmptyBorder emptyBorder,
                  JCheckBox jCheckBox, JLabel jLabelId, JCheckBox jCheckBoxClick, JTextField jTextField, JTextField jTextFieldLabel,
                  Element element) {
        super(layout);
        ...
        annotationForId = jTextFieldLabel;
    ...
    private void initComponent(Element element) {
        ...
        annotationForId.setEnabled(element.isCreateFiled());
        ...
        annotationForId.setHorizontalAlignment(JTextField.LEFT);
        // 监听
        mEnableCheckBox.addActionListener(e -> {
            if (mEnableListener != null) {
                ...
                annotationForId.setEnabled(mEnableCheckBox.isSelected());
        ...
        // id注释监听
        annotationForId.addFocusListener(new FocusListener() {
            @Override
            public void focusGained(FocusEvent e) {
                if (annotationForIdFocusListener != null) {
                    annotationForIdFocusListener.setAnnotationForId(annotationForId);
                }
            }
